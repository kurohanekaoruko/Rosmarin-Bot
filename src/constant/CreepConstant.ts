...
export const RoleData: RoleConfig = {
    ...
    'transport': {
        ...
        level: 2, code: 'T', action: Role.transport
    }, // 资源搬运
    'manager': {
        bodypart: [[CARRY, 4], [MOVE, 2]],
        level: 1, code: 'M', action: Role.manager
    }, // 中央搬运
    'upgrader': {
    ...
    'signer': {
        bodypart: [[MOVE, 1]],
        level: 11, code: 'SIG', action: Role.signer
    }, // 签名
    ...
    'defend-2Attack': {
        ...
        level: 7, code: "D2A", must: true, action: Role.defend_2Attack
    },
    'defend-2Heal': {
        bodypart: [[TOUGH, 10], [HEAL, 30], [MOVE, 10]],
        level: 7, code: "D2H", must: true, action: Role.defend_2Heal
    },

    /* 外矿相关 */
    /* 外矿 */
    'reserver': { bodypart: [], level: 11, code: 'RSV', work: Role.reserve },
...
export const RoleLevelData = {
    'harvester': {
        ...
        5: { bodypart: [[WORK, 10], [CARRY, 4], [MOVE, 5]], num: 0 },
